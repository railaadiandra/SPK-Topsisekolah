              ...
              <tbody>
                ...
                foreach ($data as $nama => $krit) {
                  echo "<tr>
                      ...
                      <td>{$nama}</td>";
                  foreach ($kriteria as $k) {
                    echo "<td align='center'>" . round(($krit[$k] / sqrt($nilai_kuadrat[$k])), 4) . "</td>"; //rating kinerja ternormalisasi
                  }
                  echo
                  "</tr>\n";
                }
              ...
              <tbody>
                ...
                foreach ($data as $nama => $krit) {
                  echo "<tr>
                      ...
                      <td>{$nama}</td>";
                  foreach ($kriteria as $k) {
                    $y[$k][$i - 1] = round((($krit[$k] / sqrt($nilai_kuadrat[$k]))), 3) * $bobot[$k]; //Rating bobot ternormalisasi
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  $yplus = array();
                  foreach ($kriteria as $k) {
                    $yplus[$k] = ([$k] ? max($y[$k]) : min($y[$k])); //Solusi ideal Positif
                    echo "<th>$yplus[$k]</th>";
                  }
                  ?>
                </tr>
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  $ymin = array();
                  foreach ($kriteria as $k) {
                    $ymin[$k] = [$k] ? min($y[$k]) : max($y[$k]); //solusi ideal negatif
                    echo "<th>{$ymin[$k]}</th>";
                  }
              ...
              <tbody>
                ...
                foreach ($data as $nama => $krit) {
                  ...
                  foreach ($kriteria as $k) {
                    ...
                    $dplus[$i - 1] += pow($yplus[$k] - $y[$k][$i - 1], 2); //jarak Positif
                  }
              ...
              <tbody>
                ...
                foreach ($data as $nama => $krit) {
                  ...
                  foreach ($kriteria as $k) {
                    ...
                    $dmin[$i - 1] += pow($ymin[$k] - $y[$k][$i - 1], 2); //Jarak negatif
                  }
